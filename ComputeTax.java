...
public class ComputeTax{
	public static void main(String[] args){
		...
		// ask members to enter filing status
		...
		//compute tax
		double tax = 0;
		if (status == 0){//compute tax for single filer
			if (income <= 8350)
				tax = income * 0.10;
			...
			if (income <= 16700)
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050- 67900) * 0.25 + (208850 - 137050) + (income -208850) * 0.33;
			else 
				tax = 16700 * 0.10 + (67900 -16700) * 0.15 + (137050 - 67900) * 0.25 + (208550 - 137050) + (372950-208850) * 0.33 + (income -372950) * 0.35;
		}
			...
			if (income <= 8350)
				...
				tax = 8250 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (income - 186475) * 0.35;
		}
